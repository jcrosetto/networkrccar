...
public class Cockpit implements KeyListener, ActionListener {
	...
	public Cockpit() {
		...
		//grab all of the controlPane images
	...
	private void addComponentsToPane(Container pane) {
		...
		controlPane.add(leftInd);
		controlPane.add(Box.createHorizontalGlue());
		controlPane.add(speedGauge);
		controlPane.add(Box.createHorizontalGlue());
		controlPane.add(rightInd);
		controlPane.add(Box.createRigidArea(new Dimension(15,0)));
		
		// add live view, controlPane, and button to view tab
		view.add(axPanel);
		...
		Dimension paneSize = new Dimension(350, 350);
